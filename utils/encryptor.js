...
function logisticEncrypt(inputFilePath, outputFilePath, keyFilePath) {
	...
	console.log(
		'Encryption complete with Logistic Map. Key saved to',
		keyFilePath
	);
}
...
function logisticDecrypt(inputFilePath, outputFilePath, keyFilePath) {
	...
	console.log(
		'Decryption complete with Logistic Map. Decrypted image saved to',
		outputFilePath
	);
}
...
function encryptImage(inputFilePath, outputFilePath, keyFilePath, algorithm) {
	...
	if (algorithm === 'aes') {
		...
		console.error(
			'Unsupported algorithm. Please use "aes", "des", or "logistic".'
		);
		return;
	}
...
function decryptImage(inputFilePath, outputFilePath, keyFilePath, algorithm) {
	...
	output.on('finish', () => {
		console.log(
			'Decryption complete. Decrypted image saved to',
			outputFilePath
		);
	});
}
